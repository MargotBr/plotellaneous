...
ggsave(
 filename = file.path(here::here(), "tidytuesday-2023-05-23/interplots/map_central_park_plot.png"),
...
map_squirrels_image_plot_size_font
...
grid.draw(gList(
  ...
  ggplotGrob(map_squirrels_image_plot_size_font)
))
